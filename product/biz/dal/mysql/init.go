...
func Init() {
	...
	if os.Getenv("GO_ENV") != "online" {
		...
		if needDemoData {
			DB.Exec("INSERT INTO `gomall`.`category` VALUES (1,'2023-12-06 15:05:06','2023-12-06 15:05:06','T-Shirt','T-Shirt'),(2,'2023-12-06 15:05:06','2023-12-06 15:05:06','Sticker','Sticker')")
